void DrawProfile(const Int_t phislice=90, const Int_t rslice=17, const Int_t zslice=17, const Bool_t useSCmean = kTRUE, const Bool_t useSCFluc=kTRUE, const Bool_t isR=kTRUE, const Bool_t isRPhi = kFALSE, const Bool_t isZ=kFALSE);
void DrawStdDev(const Int_t phislice=90, const Int_t rslice=17, const Int_t zslice=17, const Bool_t useSCmean = kTRUE, const Bool_t useSCFluc=kTRUE, const Bool_t isR=kTRUE, const Bool_t isRPhi = kFALSE, const Bool_t isZ=kFALSE);
void DrawMeanSD(const Int_t phislice=90, const Int_t rslice=17, const Int_t zslice=17, const Bool_t useSCmean = kTRUE, const Bool_t useSCFluc=kTRUE, const Bool_t isR=kTRUE, const Bool_t isRPhi = kFALSE, const Bool_t isZ=kFALSE);
void DrawNfilter(const Int_t phislice=90, const Int_t rslice=17, const Int_t zslice=17, const Bool_t useSCmean = kTRUE, const Bool_t useSCFluc=kTRUE, const Bool_t isR=kTRUE, const Bool_t isRPhi = kFALSE, const Bool_t isZ=kFALSE, const Int_t Nev=3000);
void DrawProfileAll(){

	DrawProfile(90,17,17,kTRUE,kTRUE,kTRUE,kFALSE,kFALSE);
	DrawProfile(90,17,17,kTRUE,kTRUE,kFALSE,kTRUE,kFALSE);
	DrawProfile(90,17,17,kTRUE,kTRUE,kFALSE,kFALSE,kTRUE);

	DrawProfile(90,17,17,kFALSE,kTRUE,kTRUE,kFALSE,kFALSE);
	DrawProfile(90,17,17,kFALSE,kTRUE,kFALSE,kTRUE,kFALSE);
	DrawProfile(90,17,17,kFALSE,kTRUE,kFALSE,kFALSE,kTRUE);
